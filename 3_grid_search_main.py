...
data_path = "./data/"
file_name = "facebook_ego/fb_1684"
file_name = "sina"
...
alpha = 1  # 我们将初始的hyper parameter值设置为1，方便训练
num_of_iter = 10

for alpha in np.arange(lower_bound, upper_bound, (upper_bound - lower_bound) / num_of_iter):
    ...
    # 重新设置下一轮的alpha
    plot_rs(lower_bound, upper_bound, train_features, train_labels)
    plt.show()
